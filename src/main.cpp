...
private:
    ...
    QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device)
    {
        ...
        // TODO: Update this to prioritise finding a single queue family that supports both draw commands and surface presentation
        int i = 0;
    ...
    {
        auto vertShaderCode = readFile("shaders/triangle.vert.glsl.spv");
        auto fragShaderCode = readFile("shaders/triangle.frag.glsl.spv");
